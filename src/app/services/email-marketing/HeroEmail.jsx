            ...
            <div className={`space-y-6 sm:space-y-10 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-sm sm:text-base md:text-lg lg:text-lg text-blue-100 leading-relaxed max-w-2xl font-light">
                  Transform your email strategy with AI-powered campaigns that 
                  <span className="text-cyan-300 font-semibold"> drive engagement</span>, 
                  <span className="text-cyan-300 font-semibold"> boost conversions</span>, and 
                  <span className="text-cyan-300 font-semibold"> grow your business</span>.
                </p>
              </div>
