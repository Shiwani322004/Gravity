...
import { ArrowRight, ChevronLeft, ChevronRight, TrendingUp, Award, Zap, Users, X } from 'lucide-react';
...
const HeroABM = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      alert('Thank you! Our ABM specialist will contact you soon.');
    }, 2000);
  };
            ...
            <div className={`space-y-6 sm:space-y-10 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="space-y-4 sm:space-y-6">
                <h1 className="text-4xl font-black leading-tight tracking-tight text-left">
                  <span className="block text-4xl">ACCOUNT-BASED</span>
                ...
                <p className="text-sm sm:text-base md:text-lg lg:text-lg text-blue-100 leading-relaxed max-w-2xl font-light">
                  Transform your B2B revenue strategy with targeted ABM that 
                  <span className="text-cyan-300 font-semibold"> engages key accounts</span>, 
                  <span className="text-cyan-300 font-semibold"> accelerates pipeline</span>, and 
                  <span className="text-cyan-300 font-semibold"> drives enterprise growth</span>.
                </p>
              </div>
