      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center min-h-[80vh]">
          ...
          <div className={`space-y-6 sm:space-y-10 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            ...
            {/* Trust Indicators */}
            <div className={`flex flex-col sm:flex-row items-center gap-4 sm:gap-6 pt-6 sm:pt-8 transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-blue-200 text-sm font-medium">Brand-safe platforms</span>
              </div>
            </div>
          </div>
