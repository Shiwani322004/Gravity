            ...
            <div className={`transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="bg-white rounded-3xl p-8 sm:p-10 lg:p-12 shadow-2xl border border-gray-100">
                ...
                <div className="mb-8">
                  ...
                  <p className="text-gray-600">Get your content seen by the right audience across premium publishing networks.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="relative group">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        onFocus={() => setFocusedField('contentType')}
                        onBlur={() => setFocusedField(null)}
                        className="w-full border-2 border-gray-200 rounded-xl px-5 py-3 text-gray-900 focus:outline-none focus:border-blue-500 cursor-pointer font-medium"
                        required
                      >
                        <option value="">Select Content Type</option>
                        <option value="whitepapers">Whitepapers & eBooks</option>
                    ...
                    <div className="relative group">
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        onFocus={() => setFocusedField('contentGoal')}
                        onBlur={() => setFocusedField(null)}
                        className="w-full border-2 border-gray-200 rounded-xl px-5 py-3 text-gray-900 focus:outline-none focus:border-blue-500 cursor-pointer font-medium"
                        required
                      >
                  ...
                  <p className="text-center text-gray-500 text-sm mt-4">
                    By submitting, you agree to our privacy policy and consent to contact about our content syndication services.
                  </p>
                </form>
              </div>
            </div>
              ...
              <div className="space-y-8">
                <div>
                  <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-4">
                    ...
                    <span className="block text-blue-600">Syndication Impact</span>
                  </h2>
                  <p className="text-gray-600 text-lg mt-6">Distribute your content across premium networks and reach your target audience effectively.</p>
                </div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-gray-800 font-semibold text-lg">Access to 500+ premium publishing partners</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-gray-800 font-semibold text-lg">Guaranteed content placement and visibility</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-gray-800 font-semibold text-lg">Detailed performance analytics and ROI tracking</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-gray-800 font-semibold text-lg">Industry-specific audience targeting</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-gray-800 font-semibold text-lg">Content optimization for maximum engagement</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-gray-800 font-semibold text-lg">Dedicated content strategy team</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6 mt-10">
                  <div className="text-center p-6 bg-blue-50 rounded-2xl">
                    ...
                    <div className="text-gray-700 font-medium">Monthly Readers</div>
                  </div>
                  <div className="text-center p-6 bg-blue-50 rounded-2xl">
                ...
                <div className="mt-10 p-8 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl border-2 border-blue-200">
                  <h4 className="text-2xl font-bold text-gray-900 mb-3">Need Lead Generation?</h4>
                  <p className="text-gray-700 mb-6">Drive qualified leads with our targeted lead generation services</p>
...
export default ContentSyndicationForm;