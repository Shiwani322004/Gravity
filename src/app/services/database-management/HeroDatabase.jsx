...
import { ArrowRight, ChevronLeft, ChevronRight, Database, Shield, Cpu, Zap, X } from 'lucide-react';
...
const HeroDatabase = () => {
  ...
  const heroImages = [
    {
      url: "https://images.unsplash.com/photo-1544383835-bda2bc66a55d?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      title: "Real-time Analytics",
      description: "Monitor your database performance in real-time"
    },
    {
      url: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      title: "Secure Backups",
      description: "Automated backups with military-grade encryption"
    },
    {
      url: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      title: "Smart Optimization",
      description: "AI-powered database optimization and tuning"
    }
  ];

  const stats = [
    { icon: Database, value: "2.4 TB", label: "Total Data", color: "from-green-400 to-emerald-500" },
    { icon: Cpu, value: "99.9%", label: "Uptime", color: "from-purple-400 to-violet-500" },
    { icon: Shield, value: "256-bit", label: "Encryption", color: "from-orange-400 to-red-500" },
    { icon: Zap, value: "47ms", label: "Avg Response", color: "from-blue-400 to-cyan-500" }
  ];
            ...
            <div className={`space-y-6 sm:space-y-10 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-100 leading-relaxed max-w-2xl font-light">
                  Transform your data strategy with AI-powered database management that 
                  <span className="text-cyan-300 font-semibold"> ensures performance</span>, 
                  <span className="text-cyan-300 font-semibold"> guarantees security</span>, and 
                  <span className="text-cyan-300 font-semibold"> scales effortlessly</span>.
                </p>
              </div>
