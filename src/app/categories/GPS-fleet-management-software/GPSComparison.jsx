...
import { CheckCircle, X, Zap, ArrowRight, Star, Navigation, MapPin, Car, Shield, Gauge, RefreshCw } from 'lucide-react';
import { useState } from 'react';
import Image from 'next/image';

export default function GPSFleetComparison() {
  ...
  const questions = [
    {
      ...
      options: ["1-5", "6-15", "16-25", "26-50", "50+"]
    },
    {
      question: "What's your primary need for GPS tracking?",
      options: ["Route optimization", "Driver safety", "Fuel management", "Maintenance tracking", "All of the above"]
    },
    {
      question: "Which features are most important to you?",
      options: ["Real-time tracking", "Fuel monitoring", "Driver behavior", "Maintenance alerts", "Compliance reporting"]
    },
    {
