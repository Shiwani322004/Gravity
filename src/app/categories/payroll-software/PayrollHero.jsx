      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`max-w-4xl mx-auto mb-12 sm:mb-16 transition-all duration-1000 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl font-bold mb-6 lg:mb-8 text-left">
                  ...
                  <div className="space-y-4 sm:space-y-6 pt-4">
                    ...
                    <div className="space-y-3 sm:space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#007bff] rounded-full mt-3 flex-shrink-0"></div>
                        <div>
                          <strong className="text-[#007bff]">Scalable Growth:</strong> Choose systems that grow with your business, from startup to enterprise scale.
                        </div>
                      </div>
