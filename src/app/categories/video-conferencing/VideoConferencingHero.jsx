...
export default function VideoConferencingHero() {
  ...
  const providerCards = [
    {
      ...
      features: ["HD video meetings", "Screen sharing", "Cloud recording"],
      buttonText: "Compare Quotes",
    },
    {
      vendorLogo: "/images/goto.png",
      price: "Starts at $12/user/month",
      features: ["Easy setup", "Mobile apps", "24/7 support"],
      buttonText: "Compare Quotes",
    },
    {
      vendorLogo: "/images/ringcentral.png",
      price: "Starts at $19.99 per user/month",
      features: ["Unified communications", "Team messaging", "Phone integration"],
      buttonText: "Compare Quotes",
    },
    {
      vendorLogo: "/images/cloud.png",
      price: "Custom pricing available",
      features: ["Enterprise security", "Advanced analytics", "API integrations"],
      buttonText: "Compare Quotes",
    },
    {
      vendorLogo: "/images/hubspot.png",
      price: "Starts at $45 per user/month",
      features: ["CRM integration", "Meeting scheduling", "Sales tools"],
      buttonText: "Compare Quotes",
    }
  ];
  ...
  const questions = [
    {
      question: "What type of video conferencing do you need?",
      options: [
        "Team Meetings & Collaboration",
        "Client Presentations & Sales",
    ...
    {
      question: "How many participants do you typically have?",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const submissionData = {
        ...
        meeting_type: answers.meetingType || 'Not specified',
        participant_count: answers.participantCount || 'Not specified',
        important_features: answers.importantFeatures || 'Not specified',
        use_case: answers.useCase || 'Not specified',
        subject: `Video Conferencing Inquiry from ${formData.name}`,
        from_name: 'Video Conferencing Finder'
      };
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`max-w-4xl mx-auto mb-16 transition-all duration-1000 delay-600 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
            <h2 className="text-5xl font-bold mb-8 text-left">
              ...
              <span className="text-[#007bff]">Video Conferencing</span>
              <span className="text-black"> Solutions of 2025</span>
            </h2>
            
            <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
              <p>
                At <strong className="text-[#007bff]">B2B Gravity</strong>, we help you find the perfect video conferencing solution to connect your team and clients seamlessly. Our curated selection of <strong className="text-[#007bff]">video conferencing platforms</strong> offers HD video quality, screen sharing, and collaboration tools to enhance communication and productivity.
              </p>

              <h3 className="text-2xl font-bold text-gray-900 mt-8">Why Upgrade Your Video Conferencing?</h3>
              <p>
                Modern video conferencing goes beyond basic video calls. Get advanced features like screen sharing, recording, virtual backgrounds, and real-time collaboration—tools that help your team stay connected and productive from anywhere.
              </p>
              <p>
                From small team meetings to large webinars, the right solution scales with your needs. Enjoy crystal-clear audio and video, mobile accessibility, and seamless integrations to enhance your communication experience.
              </p>
              ...
              {!showMore ? (
                ...
                <>
                  <h3 className="text-2xl font-bold text-gray-900 mt-8">Comprehensive Video Conferencing Features</h3>
                  <p>
                    Whether you need internal team meetings, client presentations, or large-scale webinars, <strong className="text-[#007bff]">B2B Gravity</strong> connects you with solutions featuring breakout rooms, meeting recording, calendar integration, and advanced security features.
                  </p>
                  <p>
                    Discover cloud-based platforms with mobile apps, virtual backgrounds, and real-time chat—all designed to make remote collaboration seamless and engaging. Explore packages with HD video, screen sharing, file sharing, and more.
                  </p>
                </>
              )}
            </div>
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200/60 shadow-lg max-w-2xl mx-auto relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 mb-6">
                  Our video conferencing experts help you compare features and pricing from top providers with recommendations tailored for your team size and communication needs.
                </p>
                <h4 className="text-lg font-semibold text-blue-700 mb-2">Get Expert Advice & Instant Quotes</h4>
                <p className="text-gray-700 mb-6">
                  Unsure what to pick? Fill out our quick form for direct quotes and side-by-side comparisons, so you can invest with confidence and enhance team collaboration.
                </p>
                <button
                  onClick={handleOpenQuestionnaire}
                ...
                >
                  Get Your Free Video Conferencing Quotes
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-auto transform transition-all duration-300 scale-100 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 bg-white z-10">
              <h3 className="text-xl font-bold text-gray-900">
                {isCompleted ? "Thank You!" : "Find Your Perfect Video Conferencing Solution"}
              </h3>
              <button
            ...
            <div className="p-6">
              {isCompleted ? (
                <div className="text-center py-8">
                  ...
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">Perfect Video Conferencing Match Found!</h4>
                  <p className="text-gray-600 mb-6">
                    Based on your responses, you'll receive personalized video conferencing recommendations and quotes in your inbox soon.
                  </p>
                  <button
                    onClick={handleCloseQuestionnaire}
