...
export default function ERPAction() {
  const [activeFeature, setActiveFeature] = useState(0);

  const demoFeatures = [
    {
      title: "Integrated Financial Management",
      description: "Comprehensive financial control with automated accounting, real-time reporting, and multi-currency support for global operations",
      steps: ["Transaction capture", "Automated processing", "Real-time reporting", "Financial insights"],
      demoImage: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
    },
    {
      title: "Supply Chain Optimization",
      description: "End-to-end supply chain management with inventory control, demand planning, and automated procurement processes",
      steps: ["Demand forecasting", "Inventory planning", "Automated ordering", "Delivery tracking"],
    ...
    },
    {
      ...
      description: "Advanced analytics and reporting with real-time KPI monitoring, predictive insights, and customizable dashboards",
      steps: ["Data collection", "Analytics processing", "Insight generation", "Dashboard updates"],
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl lg:text-5xl font-bold mb-4">
            See ERP Solutions In Action
          </h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Interactive demonstration of our key ERP features and business workflows
          </p>
        </div>
