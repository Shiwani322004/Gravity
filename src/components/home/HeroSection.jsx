...
const services = [
  ...
  { name: 'Content Syndication', link: '/services/content-syndication' },
  { name: 'Email Marketing', link: '/services/email-marketing' },
  { name: 'Account-Based Marketing', link: '/services/account-based-marketing' }
];

const categories = [
  { name: 'Phone System', link: '/categories/phone-system' },
  { name: 'CRM System', link: '/categories/crm-system' },
  { name: 'Business Intelligence', link: '/categories/business-intelligence' },
  { name: 'GPS Fleet Management Software', link: '/categories/gps-fleet' },
  { name: 'Payroll Software', link: '/categories/payroll-software' }
];
...
{/* Carousel - Centered */}
        ...
        <div className="flex flex-col gap-7 mt-10 lg:mt-0 w-full lg:w-[360px] xl:w-[420px] items-center lg:items-end z-50">
          {/* Services Card */}
          <div className="bg-white/20 backdrop-blur-2xl rounded-3xl shadow-2xl border border-blue-100/20 p-6 flex flex-col gap-4 transition-all duration-300 hover:bg-white/25 hover:shadow-blue-400/20 w-full max-w-xs lg:max-w-none">
            ...
            <ul className="flex flex-col gap-3">
              {services.map((service) => (
                <li key={service.name}>
                  ...
                  >
                    <span className="service-icon w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 shadow-lg border border-white/30 flex-shrink-0" />
          ...
          {/* Categories Card */}
          <div className="bg-white/20 backdrop-blur-2xl rounded-3xl shadow-2xl border border-purple-100/20 p-6 flex flex-col gap-4 transition-all duration-300 hover:bg-white/25 hover:shadow-purple-300/20 w-full max-w-xs lg:max-w-none">
              ...
              {categories.map((category) => (
                <li key={category.name}>
                  <a
                    ...
                    className="service-btn flex items-center gap-4 p-3 rounded-xl hover:bg-white/10 group"
                  >
                    <span className="service-icon w-10 h-10 rounded-xl bg-gradient-to-br from-pink-400 via-purple-500 to-orange-400 shadow-lg border border-white/30 flex-shrink-0" />
