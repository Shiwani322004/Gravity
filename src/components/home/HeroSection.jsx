  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col justify-between px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-6 sm:py-8 lg:py-10 xl:py-12">
        ...
        <div className="max-w-xl sm:max-w-2xl lg:max-w-3xl animate-fade-in-up">
          {/* Main Heading */}
        ...
        <div className="flex flex-col items-center sm:items-end justify-center sm:justify-end animate-fade-in mt-8 sm:mt-0" style={{ animationDelay: '0.3s', marginBottom: '-20px' }}>
          
          {/* Card Carousel and Arrows Container */}
          <div className="relative w-full sm:w-auto flex flex-col items-center sm:items-end">
            {/* Card Carousel Container - Three cards visible, pushed upward */}
            ...
            {/* Navigation Arrows - Positioned below the second card */}
            <div className="flex gap-2 sm:gap-3 mt-4" style={{ marginRight: 'calc(clamp(140px, 40vw, 200px) / 2 + clamp(6px, 2vw, 8px) - 20px)' }}>
              <button
